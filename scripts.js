...
// iOS-specific fix to prevent "coming soon" alerts
if (/iPad|iPhone|iPod/.test(navigator.userAgent)) {
    // Override window.alert specifically for iOS
    const originalAlert = window.alert;
    window.alert = function(message) {
        // Only block "coming soon" messages
        if (message !== 'This page is coming soon!') {
            originalAlert(message);
        }
    };
    
    // Remove any click event listeners on links that might trigger alerts
    document.querySelectorAll('a').forEach(link => {
